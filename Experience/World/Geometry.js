...
export default class Geometry {
	...
	countdown = () => {
		...
		this.txtHour = Math.floor(
			(this.gap % this.day) / this.hour
		);
		this.txtMinute = Math.floor(
			(this.gap % this.hour) / this.minute
		);
		this.txtSecond = Math.floor(
			(this.gap % this.minute) / this.second
		);
